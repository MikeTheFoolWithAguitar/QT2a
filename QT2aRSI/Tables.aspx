<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tables.aspx.cs" Inherits="WingtipToys.QT2aRSI.Tables" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="divTables">
            <h2>QualifiedTruckers QT2a SQL Server Database Tables</h2>
                <asp:Button ID="btnEmployees" runat="server" Text="Employees" OnClick="btnEmployees_Click" />
                <asp:Button ID="btnDocuments" runat="server" Text="Documents" OnClick="btnDocuments_Click" />
                <asp:Button ID="btnDrugTestResults" runat="server" Text="DrugTestResults" OnClick="btnDrugTestResults_Click" />
                <asp:Button ID="btnPreviousEmployers" runat="server" Text="PreviousEmployers" OnClick="btnPreviousEmployers_Click" />
                <asp:Button ID="btnCompanies" runat="server" Text="Companies" OnClick="btnCompanies_Click" />
                <asp:Button ID="btnPrograms" runat="server" Text="Programs" OnClick="btnPrograms_Click" />
                <asp:Button ID="btnDocTypes" runat="server" Text="DocTypes" OnClick="btnDocTypes_Click" />
                <asp:Button ID="btnDocStatus" runat="server" Text="DocStatus" OnClick="btnDocStatus_Click" />
                <asp:Button ID="btnCollectionSites" runat="server" Text="CollectionSites" OnClick="btnCollectionSites_Click" />
                <asp:Button ID="btnLaboratories" runat="server" Text="Laboratories" OnClick="btnLaboratories_Click" />
                <asp:Button ID="btnMedicalReviewOfficers" runat="server" Text="MedicalReviewOfficers" OnClick="btnMedicalReviewOfficers_Click" />
                <asp:Button ID="btnDrugTestTypes" runat="server" Text="DrugTestTypes" OnClick="btnDrugTestTypes_Click" />
                <asp:Button ID="btnDrugTypes" runat="server" Text="DrugTypes" OnClick="btnDrugTypes_Click" />
                <div id="divEmployee">
                <asp:Label ID="lblEmployees" Visible="false" runat="server" Text="Employees"></asp:Label>
                ...
                <asp:DetailsView ID="dtvEmployees" Visible="false"  OnItemCreated="dtvEmployee_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="EmployeeID" DataSourceID="sdsEmployee" EnableModelValidation="True">
                    <Fields>
                ...
                <asp:GridView ID="gvEmployees" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="EmployeeID" DataSourceID="sdsEmployee" EnableModelValidation="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Company">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlCompanyInEmployeegv" DataSourceID="sdsForDdlCompanyInEmployeeDtv"
                                    DataTextField="CompanyName" DataValueField="CompID" Enabled="false"
                                    SelectedValue='<%# Bind("CompID") %>' runat="server" />
                            </ItemTemplate>
                            <EditItemTemplate>
            ...
            <div id="divCompany">
                <asp:Label ID="lblCompanies" Visible="false" runat="server" Text="Companies"></asp:Label>
                ...
                <asp:SqlDataSource ID="sdsForddlProgramInCompanyDdl" runat="server" ConnectionString='<%$ ConnectionStrings:QT2a %>' SelectCommand="SELECT [ProgID], [ProgName] FROM [Programs] ORDER BY [ProgName]"></asp:SqlDataSource>
                <asp:DetailsView ID="dtvCompany" Visible="false" OnItemCreated="dtvCompany_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="CompID" DataSourceID="sdsCompany" EnableModelValidation="True">
                    <Fields>
                        <asp:BoundField DataField="CompID" HeaderText="CompID" InsertVisible="False" ReadOnly="True" SortExpression="CompID" />
                        <asp:BoundField DataField="CompanyName" HeaderText="CompanyName" SortExpression="CompanyName" />
                        <asp:CheckBoxField DataField="NonDOTRandoms" HeaderText="NonDOTRandoms" SortExpression="NonDOTRandoms" />
                        <%--<asp:BoundField DataField="ProgID" HeaderText="ProgID" SortExpression="ProgID" />--%>
                        <asp:TemplateField HeaderText="Program">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlProgramInCompanyDdl" DataSourceID="sdsForddlProgramInCompanyDdl"
                                    DataTextField="ProgName" DataValueField="ProgID"
                                    SelectedValue='<%# Bind("ProgID") %>' runat="server" />
                            </ItemTemplate>
                            <InsertItemTemplate>
                                <asp:DropDownList ID="ddlProgramInCompanyDdl" DataSourceID="sdsForddlProgramInCompanyDdl"
                                    DataTextField="ProgName" DataValueField="ProgID"
                                    SelectedValue='<%# Bind("ProgID") %>' runat="server" AppendDataBoundItems="true" >
                        ...
                        <asp:BoundField DataField="SICCode" HeaderText="SICCode" SortExpression="SICCode" />
                        <asp:BoundField DataField="InsPolicyNo" HeaderText="InsPolicyNo" SortExpression="InsPolicyNo" />
                        <asp:BoundField DataField="UCReportingNo" HeaderText="UCReportingNo" SortExpression="UCReportingNo" />
                        <asp:BoundField DataField="LicReviewPerson" HeaderText="LicReviewPerson" SortExpression="LicReviewPerson" />
                        <asp:BoundField DataField="LicReviewTitle" HeaderText="LicReviewTitle" SortExpression="LicReviewTitle" />
                        <asp:BoundField DataField="Notes" HeaderText="Notes" SortExpression="Notes" />
                        <asp:CheckBoxField DataField="OwnerOperator" HeaderText="OwnerOperator" SortExpression="OwnerOperator" />
                        <asp:CheckBoxField DataField="PASI210" HeaderText="PASI210" SortExpression="PASI210" />
                        <asp:CheckBoxField DataField="PASQ320" HeaderText="PASQ320" SortExpression="PASQ320" />
                        <asp:CheckBoxField DataField="PASQ400" HeaderText="PASQ400" SortExpression="PASQ400" />
                        <asp:CheckBoxField DataField="PASScanning" HeaderText="PASScanning" SortExpression="PASScanning" />
                        <asp:CheckBoxField DataField="Misc" HeaderText="Misc" SortExpression="Misc" />
                        <asp:BoundField DataField="Address1Note" HeaderText="Address1Note" SortExpression="Address1Note" />
                        <asp:BoundField DataField="Address1" HeaderText="Address1" SortExpression="Address1" />
                        <asp:BoundField DataField="City1" HeaderText="City1" SortExpression="City1" />
                        <asp:BoundField DataField="State1" HeaderText="State1" SortExpression="State1" />
                        <asp:BoundField DataField="ZipCode1" HeaderText="ZipCode1" SortExpression="ZipCode1" />
                        <asp:BoundField DataField="Address2Note" HeaderText="Address2Note" SortExpression="Address2Note" />
                        <asp:BoundField DataField="Address2" HeaderText="Address2" SortExpression="Address2" />
                        <asp:BoundField DataField="City2" HeaderText="City2" SortExpression="City2" />
                        <asp:BoundField DataField="State2" HeaderText="State2" SortExpression="State2" />
                        <asp:BoundField DataField="ZipCode2" HeaderText="ZipCode2" SortExpression="ZipCode2" />
                        <asp:BoundField DataField="Contact1FName" HeaderText="Contact1FName" SortExpression="Contact1FName" />
                        <asp:BoundField DataField="Contact1LName" HeaderText="Contact1LName" SortExpression="Contact1LName" />
                        <asp:BoundField DataField="Contact1Title" HeaderText="Contact1Title" SortExpression="Contact1Title" />
                        <asp:BoundField DataField="Contact1PhoneNo1" HeaderText="Contact1PhoneNo1" SortExpression="Contact1PhoneNo1" />
                        <asp:BoundField DataField="Contact1PhoneNo2" HeaderText="Contact1PhoneNo2" SortExpression="Contact1PhoneNo2" />
                        <asp:BoundField DataField="Contact1PhoneNo3" HeaderText="Contact1PhoneNo3" SortExpression="Contact1PhoneNo3" />
                        <asp:BoundField DataField="Contact1Fax" HeaderText="Contact1Fax" SortExpression="Contact1Fax" />
                        <asp:BoundField DataField="Contact1EMail" HeaderText="Contact1EMail" SortExpression="Contact1EMail" />
                        <asp:BoundField DataField="Contact2FName" HeaderText="Contact2FName" SortExpression="Contact2FName" />
                        <asp:BoundField DataField="Contact2LName" HeaderText="Contact2LName" SortExpression="Contact2LName" />
                        <asp:BoundField DataField="Contact2Title" HeaderText="Contact2Title" SortExpression="Contact2Title" />
                        <asp:BoundField DataField="Contact2PhoneNo1" HeaderText="Contact2PhoneNo1" SortExpression="Contact2PhoneNo1" />
                        <asp:BoundField DataField="Contact2PhoneNo2" HeaderText="Contact2PhoneNo2" SortExpression="Contact2PhoneNo2" />
                        <asp:BoundField DataField="Contact2PhoneNo3" HeaderText="Contact2PhoneNo3" SortExpression="Contact2PhoneNo3" />
                        <asp:BoundField DataField="Contact2Fax" HeaderText="Contact2Fax" SortExpression="Contact2Fax" />
                        <asp:BoundField DataField="Contact2EMail" HeaderText="Contact2EMail" SortExpression="Contact2EMail" />
                        <asp:BoundField DataField="LastUpdated" HeaderText="LastUpdated" SortExpression="LastUpdated" />
                        <asp:BoundField DataField="UpdatedBy" HeaderText="UpdatedBy" SortExpression="UpdatedBy" />
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowInsertButton="True" />
                    </Fields>
                </asp:DetailsView>
                <asp:GridView ID="gvCompany" Visible=false OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="sdsCompany" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                    </Columns>
                </asp:GridView>
            ...
            <div id="divPrograms">
                <asp:Label ID="lblPrograms" Visible="false" runat="server" Text="Programs"></asp:Label>
                <asp:SqlDataSource ID="sdsPrograms" runat="server" ConflictDetection="CompareAllValues" ConnectionString='<%$ ConnectionStrings:QT2a %>' DeleteCommand="DELETE FROM [Programs] WHERE [ProgID] = @original_ProgID AND (([ProgName] = @original_ProgName) OR ([ProgName] IS NULL AND @original_ProgName IS NULL)) AND (([ConsortiumNumber] = @original_ConsortiumNumber) OR ([ConsortiumNumber] IS NULL AND @original_ConsortiumNumber IS NULL)) AND (([Address1] = @original_Address1) OR ([Address1] IS NULL AND @original_Address1 IS NULL)) AND (([City1] = @original_City1) OR ([City1] IS NULL AND @original_City1 IS NULL)) AND (([State1] = @original_State1) OR ([State1] IS NULL AND @original_State1 IS NULL)) AND (([ZipCode1] = @original_ZipCode1) OR ([ZipCode1] IS NULL AND @original_ZipCode1 IS NULL)) AND (([ContactFName] = @original_ContactFName) OR ([ContactFName] IS NULL AND @original_ContactFName IS NULL)) AND (([ContactLName] = @original_ContactLName) OR ([ContactLName] IS NULL AND @original_ContactLName IS NULL)) AND (([ContactTitle] = @original_ContactTitle) OR ([ContactTitle] IS NULL AND @original_ContactTitle IS NULL)) AND (([PhoneNo1] = @original_PhoneNo1) OR ([PhoneNo1] IS NULL AND @original_PhoneNo1 IS NULL)) AND (([PhoneNo2] = @original_PhoneNo2) OR ([PhoneNo2] IS NULL AND @original_PhoneNo2 IS NULL)) AND (([PhoneNo3] = @original_PhoneNo3) OR ([PhoneNo3] IS NULL AND @original_PhoneNo3 IS NULL)) AND (([Fax] = @original_Fax) OR ([Fax] IS NULL AND @original_Fax IS NULL)) AND (([EMail] = @original_EMail) OR ([EMail] IS NULL AND @original_EMail IS NULL)) AND (([LastUpdated] = @original_LastUpdated) OR ([LastUpdated] IS NULL AND @original_LastUpdated IS NULL)) AND (([UpdatedBy] = @original_UpdatedBy) OR ([UpdatedBy] IS NULL AND @original_UpdatedBy IS NULL))" InsertCommand="INSERT INTO [Programs] ([ProgName], [ConsortiumNumber], [Address1], [City1], [State1], [ZipCode1], [ContactFName], [ContactLName], [ContactTitle], [PhoneNo1], [PhoneNo2], [PhoneNo3], [Fax], [EMail], [LastUpdated], [UpdatedBy]) VALUES (@ProgName, @ConsortiumNumber, @Address1, @City1, @State1, @ZipCode1, @ContactFName, @ContactLName, @ContactTitle, @PhoneNo1, @PhoneNo2, @PhoneNo3, @Fax, @EMail, @LastUpdated, @UpdatedBy)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Programs] ORDER BY [ProgName]" UpdateCommand="UPDATE [Programs] SET [ProgName] = @ProgName, [ConsortiumNumber] = @ConsortiumNumber, [Address1] = @Address1, [City1] = @City1, [State1] = @State1, [ZipCode1] = @ZipCode1, [ContactFName] = @ContactFName, [ContactLName] = @ContactLName, [ContactTitle] = @ContactTitle, [PhoneNo1] = @PhoneNo1, [PhoneNo2] = @PhoneNo2, [PhoneNo3] = @PhoneNo3, [Fax] = @Fax, [EMail] = @EMail, [LastUpdated] = @LastUpdated, [UpdatedBy] = @UpdatedBy WHERE [ProgID] = @original_ProgID AND (([ProgName] = @original_ProgName) OR ([ProgName] IS NULL AND @original_ProgName IS NULL)) AND (([ConsortiumNumber] = @original_ConsortiumNumber) OR ([ConsortiumNumber] IS NULL AND @original_ConsortiumNumber IS NULL)) AND (([Address1] = @original_Address1) OR ([Address1] IS NULL AND @original_Address1 IS NULL)) AND (([City1] = @original_City1) OR ([City1] IS NULL AND @original_City1 IS NULL)) AND (([State1] = @original_State1) OR ([State1] IS NULL AND @original_State1 IS NULL)) AND (([ZipCode1] = @original_ZipCode1) OR ([ZipCode1] IS NULL AND @original_ZipCode1 IS NULL)) AND (([ContactFName] = @original_ContactFName) OR ([ContactFName] IS NULL AND @original_ContactFName IS NULL)) AND (([ContactLName] = @original_ContactLName) OR ([ContactLName] IS NULL AND @original_ContactLName IS NULL)) AND (([ContactTitle] = @original_ContactTitle) OR ([ContactTitle] IS NULL AND @original_ContactTitle IS NULL)) AND (([PhoneNo1] = @original_PhoneNo1) OR ([PhoneNo1] IS NULL AND @original_PhoneNo1 IS NULL)) AND (([PhoneNo2] = @original_PhoneNo2) OR ([PhoneNo2] IS NULL AND @original_PhoneNo2 IS NULL)) AND (([PhoneNo3] = @original_PhoneNo3) OR ([PhoneNo3] IS NULL AND @original_PhoneNo3 IS NULL)) AND (([Fax] = @original_Fax) OR ([Fax] IS NULL AND @original_Fax IS NULL)) AND (([EMail] = @original_EMail) OR ([EMail] IS NULL AND @original_EMail IS NULL)) AND (([LastUpdated] = @original_LastUpdated) OR ([LastUpdated] IS NULL AND @original_LastUpdated IS NULL)) AND (([UpdatedBy] = @original_UpdatedBy) OR ([UpdatedBy] IS NULL AND @original_UpdatedBy IS NULL))">
                    <DeleteParameters>
                        <asp:Parameter Name="original_ProgID" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="original_ProgName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_ConsortiumNumber" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="original_Address1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_City1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_State1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_ZipCode1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_ContactFName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_ContactLName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_ContactTitle" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_PhoneNo1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_PhoneNo2" Type="String"></asp:Parameter>
                        <asp:Parameter Name="original_PhoneNo3" Type="String"></asp:Parameter>
                        ...
                        <asp:Parameter Name="original_UpdatedBy" Type="String"></asp:Parameter>
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="ProgName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="ConsortiumNumber" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="Address1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="City1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="State1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="ZipCode1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="ContactFName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="ContactLName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="ContactTitle" Type="String"></asp:Parameter>
                        <asp:Parameter Name="PhoneNo1" Type="String"></asp:Parameter>
                        <asp:Parameter Name="PhoneNo2" Type="String"></asp:Parameter>
                        <asp:Parameter Name="PhoneNo3" Type="String"></asp:Parameter>
                        <asp:Parameter Name="Fax" Type="String"></asp:Parameter>
                        <asp:Parameter Name="EMail" Type="String"></asp:Parameter>
                        <asp:Parameter Name="LastUpdated" Type="DateTime"></asp:Parameter>
                        <asp:Parameter Name="UpdatedBy" Type="String"></asp:Parameter>
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="ProgName" Type="String"></asp:Parameter>
                        <asp:Parameter Name="ConsortiumNumber" Type="Int32"></asp:Parameter>
                ...
                <asp:DetailsView ID="dtvPrograms" Visible="false" OnItemCreated="dtvPrograms_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" DataSourceID="sdsPrograms" EnableModelValidation="True">
                    <Fields>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowInsertButton="True" />
                    </Fields>
                </asp:DetailsView>
                <asp:GridView ID="gvPrograms" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="sdsPrograms" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                    </Columns>
                </asp:GridView>
            ...
            <div id="divDocuments">
                ...
                <asp:DetailsView ID="dtvDocuments" Visible="false" OnItemCreated="dtvDocuments_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="DocID" DataSourceID="sdsDocuments" EnableModelValidation="True">
                    <Fields>
...
<%--                        <asp:BoundField DataField="CompanyID" HeaderText="CompanyID" SortExpression="CompanyID" />--%>
                ...
                <asp:GridView ID="gvDocuments" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DocID" DataSourceID="sdsDocuments" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="DocID" HeaderText="DocID" InsertVisible="False" ReadOnly="True" SortExpression="DocID" />
                        <%--                        <asp:BoundField DataField="EmployeeID" HeaderText="EmployeeID" SortExpression="EmployeeID" />--%>
...
<%--                        <asp:BoundField DataField="CompanyID" HeaderText="CompanyID" SortExpression="CompanyID" />--%>
            ...
            <div id="divDrugTestResults">
                ...
                <asp:DetailsView ID="dtvDrugTestResults" Visible="false" OnItemCreated="dtvDrugTestResults_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="DrugTestID" DataSourceID="sdsDrugTestResults" EnableModelValidation="True">
                    <Fields>
...
<%--                        <asp:TemplateField HeaderText="CompanyName">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlCompanyInDrugTestResultsDtv" DataSourceID="sdsCompany" DataTextField="CompanyName" DataValueField="CompID" SelectedValue='<%# Bind("CompID") %>' Enabled="False" runat="server" />
                            </ItemTemplate>
                            <InsertItemTemplate>
                                <asp:DropDownList ID="ddlCompanyInDrugTestResultsDtv" DataSourceID="sdsCompany" DataTextField="CompanyName" DataValueField="CompID" SelectedValue='<%# Bind("CompID") %>' runat="server" AppendDataBoundItems="true" >
                                     <asp:ListItem Value="">Select a Company</asp:ListItem>
                                    </asp:DropDownList>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                ...
                <asp:GridView ID="gvDrugTestResults" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DrugTestID" DataSourceID="sdsDrugTestResults" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="DrugTestID" HeaderText="DrugTestID" InsertVisible="False" ReadOnly="True" SortExpression="DrugTestID" />
<%--                        <asp:BoundField DataField="LabID" HeaderText="LabID" SortExpression="LabID" />
...
<%--                        <asp:TemplateField HeaderText="CompanyName">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlCompanyInDrugTestResultsGv" DataSourceID="sdsCompany" DataTextField="CompanyName" DataValueField="CompID" SelectedValue='<%# Bind("CompID") %>' Enabled="False" runat="server" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlCompanyInDrugTestResultsGv" DataSourceID="sdsCompany" DataTextField="CompanyName" DataValueField="CompID" SelectedValue='<%# Bind("CompID") %>' Enabled="False" runat="server" />
                            </EditItemTemplate>
                ...
                <asp:DetailsView ID="dtvPreviousEmployers" Visible="false" OnItemCreated="dtvPreviousEmployers_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="PrevEmpID" DataSourceID="sdsPreviousEmployers" EnableModelValidation="True">
                    <Fields>
...
<%--                        <asp:BoundField DataField="EmployeeID" HeaderText="EmployeeID" SortExpression="EmployeeID" />--%>
                ...
                <asp:GridView ID="gvPreviousEmployers" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="PrevEmpID" DataSourceID="sdsPreviousEmployers" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="PrevEmpID" HeaderText="PrevEmpID" InsertVisible="False" ReadOnly="True" SortExpression="PrevEmpID" />
<%--                        <asp:BoundField DataField="CompID" HeaderText="CompID" SortExpression="CompID" />--%>
...
<%--                        <asp:BoundField DataField="EmployeeID" HeaderText="EmployeeID" SortExpression="EmployeeID" />--%>
            ...
            <div id="divDocTypes">
                <asp:Label ID="lblDocTypes" Visible="false" runat="server" Text="DocTypes"></asp:Label>
                ...
                <asp:DetailsView ID="dtvDocTypes" Visible="false" OnItemCreated="dtvDocTypes_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="DocTypeID" DataSourceID="sdsDocTypes" EnableModelValidation="True">
                    <Fields>
                        <asp:BoundField DataField="DocTypeID" HeaderText="DocTypeID" InsertVisible="False" ReadOnly="True" SortExpression="DocTypeID" />
                        <asp:BoundField DataField="DocumentType" HeaderText="DocumentType" SortExpression="DocumentType" />
                        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowInsertButton="True" />
                    </Fields>
                </asp:DetailsView>
                <asp:GridView ID="gvDocTypes" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DocTypeID" DataSourceID="sdsDocTypes" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="DocTypeID" HeaderText="DocTypeID" InsertVisible="False" ReadOnly="True" SortExpression="DocTypeID" />
                        <asp:BoundField DataField="DocumentType" HeaderText="DocumentType" SortExpression="DocumentType" />
            ...
            <div id="divDocStatus">
                <asp:Label ID="lblDocStatus" Visible="false" runat="server" Text="DocStatus"></asp:Label>
                ...
                <asp:DetailsView ID="dtvDocStatus" Visible="false" OnItemCreated="dtvDocStatus_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="Status" DataSourceID="sdsDocStatus" EnableModelValidation="True">
                    <Fields>
                ...
                <asp:GridView ID="gvDocStatus" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Status" DataSourceID="sdsDocStatus" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="Status" HeaderText="Status" ReadOnly="True" SortExpression="Status" />
                        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
            ...
            <div id="divCollectionSites">
                <asp:Label ID="lblCollectionSites" Visible="false" runat="server" Text="CollectionSites"></asp:Label>
                ...
                <asp:DetailsView ID="dtvCollectionSites" Visible="false" OnItemCreated="dtvCollectionSites_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="CollectionSiteID" DataSourceID="sdsCollectionSites" EnableModelValidation="True">
                    <Fields>
                        <asp:BoundField DataField="CollectionSiteID" HeaderText="CollectionSiteID" InsertVisible="False" ReadOnly="True" SortExpression="CollectionSiteID" />
                        <asp:BoundField DataField="CollName" HeaderText="CollName" SortExpression="CollName" />
                        <asp:BoundField DataField="Address1" HeaderText="Address1" SortExpression="Address1" />
                        <asp:BoundField DataField="City1" HeaderText="City1" SortExpression="City1" />
                        <asp:BoundField DataField="State1" HeaderText="State1" SortExpression="State1" />
                        <asp:BoundField DataField="ZipCode1" HeaderText="ZipCode1" SortExpression="ZipCode1" />
                        ...
                        <asp:BoundField DataField="MedicalExaminerFName" HeaderText="MedicalExaminerFName" SortExpression="MedicalExaminerFName" />
                        <asp:BoundField DataField="MedicalExaminerLName" HeaderText="MedicalExaminerLName" SortExpression="MedicalExaminerLName" />
                        <asp:BoundField DataField="MedicalExaminerTitle" HeaderText="MedicalExaminerTitle" SortExpression="MedicalExaminerTitle" />
                        <asp:BoundField DataField="LastUpdated" HeaderText="LastUpdated" SortExpression="LastUpdated" />
                        <asp:BoundField DataField="UpdatedBy" HeaderText="UpdatedBy" SortExpression="UpdatedBy" />
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowInsertButton="True" />
                    </Fields>
                </asp:DetailsView>
                <asp:GridView ID="gvCollectionSites" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CollectionSiteID" DataSourceID="sdsCollectionSites" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="CollectionSiteID" HeaderText="CollectionSiteID" InsertVisible="False" ReadOnly="True" SortExpression="CollectionSiteID" />
                        <asp:BoundField DataField="CollName" HeaderText="CollName" SortExpression="CollName" />
            ...
            <div id="divLabs">
                <asp:Label ID="lblLaboratories" Visible="false" runat="server" Text="Laboratories"></asp:Label>
                ...
                <asp:DetailsView ID="dtvLabs" Visible="false" OnItemCreated="dtvLabs_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="LabID" DataSourceID="sdsLabs" EnableModelValidation="True">
                    <Fields>
                ...
                <asp:GridView ID="gvLabs" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="LabID" DataSourceID="sdsLabs" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="LabID" HeaderText="LabID" InsertVisible="False" ReadOnly="True" SortExpression="LabID" />
                        <asp:BoundField DataField="LabName" HeaderText="LabName" SortExpression="LabName" />
            ...
            <div id="divMRO">
                <asp:Label ID="lblMedicalReviewOfficers" Visible="false" runat="server" Text="MedicalReviewOfficers"></asp:Label>
                ...
                <asp:DetailsView ID="dtvMRO" Visible="false" OnItemCreated="dtvMRO_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MROID" DataSourceID="sdsMRO" EnableModelValidation="True">
                    <Fields>
                        <asp:BoundField DataField="MROID" HeaderText="MROID" InsertVisible="False" ReadOnly="True" SortExpression="MROID" />
                ...
                <asp:GridView ID="gvMRO" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="MROID" DataSourceID="sdsMRO" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="MROID" HeaderText="MROID" InsertVisible="False" ReadOnly="True" SortExpression="MROID" />
                        <asp:BoundField DataField="LastName" HeaderText="LastName" SortExpression="LastName" />
            ...
            <div id="divDrugTestTypes">
                <asp:Label ID="lblDrugTestTypes" Visible="false" runat="server" Text="DrugTestTypes"></asp:Label>
                ...
                <asp:DetailsView ID="dtvDrugTestType" Visible="false" OnItemCreated="dvtDrugTestType_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="DrugTestTypeID" DataSourceID="sdsDrugTestType" EnableModelValidation="True">
                    <Fields>
                        <asp:BoundField DataField="DrugTestTypeID" HeaderText="DrugTestTypeID" InsertVisible="False" ReadOnly="True" SortExpression="DrugTestTypeID" />
                        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowInsertButton="True" />
                    </Fields>
                </asp:DetailsView>
                <asp:GridView ID="gvDrugTestType" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DrugTestTypeID" DataSourceID="sdsDrugTestType" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="DrugTestTypeID" HeaderText="DrugTestTypeID" InsertVisible="False" ReadOnly="True" SortExpression="DrugTestTypeID" />
                        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
            ...
            <div id="divDrugTypes">
                <asp:Label ID="lblDrugTypes" Visible="false" runat="server" Text="DrugTypes"></asp:Label>
                ...
                <asp:DetailsView ID="dtvDrugType" Visible="false" OnItemCreated="dtvDrugType_ItemCreated" runat="server" Height="50px" Width="125px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="DrugTypeID" DataSourceID="sdsDrugType" EnableModelValidation="True">
                    <Fields>
                        <asp:BoundField DataField="DrugTypeID" HeaderText="DrugTypeID" InsertVisible="False" ReadOnly="True" SortExpression="DrugTypeID" />
                        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowInsertButton="True" />
                    </Fields>
                </asp:DetailsView>
                <asp:GridView ID="gvDrugType" Visible="false" OnRowDataBound="gvRowDataBound" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DrugTypeID" DataSourceID="sdsDrugType" EnableModelValidation="True">
                    <Columns>
                        <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" />
                        <asp:BoundField DataField="DrugTypeID" HeaderText="DrugTypeID" InsertVisible="False" ReadOnly="True" SortExpression="DrugTypeID" />
                        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
    ...
    <asp:HyperLink ID="linkSQLCommandLine" NavigateUrl="~/QT2aRSI/SQLCommandLine.aspx" runat="server">SQLCommandLine</asp:HyperLink>
            <p>Click a button to display a Details View (Single Record) and a sortable Grid View (Multiple Records) for the table. Click the button again to hide the table. </br>
               Use Details View to insert, edit and delete records. Use Grid View to edit and delete records.</br>
               Don't show more than 5 tables at once or the page will become too big and cause a 'Maximum Request Length Exceeded.' error. Just reload the page if this happens.</p>
                <asp:Label ID="Label1" runat="server" ForeColor="Red"
                    Text=" DrugTestResults - ??? Looks like the Positive Drug Types
                    were defaulted to 0 giving all of those 
                    records drug type 0. They probably should be
                    set to NULL. And then handle the NULL in the
                    detailsview and gridview</>"></asp:Label>
</asp:Content>
